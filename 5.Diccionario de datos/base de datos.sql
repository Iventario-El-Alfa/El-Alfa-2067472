CREATE TABLE Cargo (
  ...
  CarDescripcion VARCHAR(30) NULL,
...
CREATE TABLE Factura (
  ...
  Personas_DocPerso INT NOT NULL,
  FactFecha DATE NOT NULL,
  totalcomp FLOAT NOT NULL,
  Totaliva FLOAT NULL,
  subtotal  FLOAT NULL,
  PRIMARY KEY(CodiFactu),
  INDEX Factura_FKIndex1(Personas_DocPerso)
);

CREATE TABLE Inventario (
  IdInven INTEGER UNSIGNED NOT NULL,
  Productos _Codiproduc INT NOT NULL,
  Entradas FLOAT NULL,
  Salidas FLOAT NULL,
  Saldo FLOAT NULL,
...
CREATE TABLE Movimientos (
  IdMovi INT NOT NULL,
  Inventario_IdInven INTEGER UNSIGNED NOT NULL,
  Personas_DocPerso INT NOT NULL,
  Detalle_Factura_CodiDetaFact INTEGER UNSIGNED NOT NULL,
  Tipo movimiento_Idmovi INT NOT NULL,
  Productos _Codiproduc INT NOT NULL,
  ...
  INDEX Movimientos_FKIndex3(Personas_DocPerso),
  INDEX Movimientos_FKIndex4(Inventario_IdInven),
  INDEX Movimientos_FKIndex5(Detalle_Factura_CodiDetaFact)
);

CREATE TABLE Personas (
  DocPerso INT NOT NULL,
...
CREATE TABLE Seguridad (
  ...
  INDEX Seguridad_FKIndex1(Registro_Correo)
);

CREATE TABLE Tipo movimiento (
  Idmovi INT NOT NULL AUTO_INCREMENT,
  TipoMoviDescripcion VARCHAR(20) NOT NULL,
  PRIMARY KEY(Idmovi)
);
